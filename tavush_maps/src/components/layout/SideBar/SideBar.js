        ...
        return (
            <div className='sideBar'>
                  <div className='properties'>
                    <button className='btn_projects'>Projects</button>
                    <button className='btn_projects'>Organizations</button>
                    <button className='btn_projects'>Spheres</button>
                    <button className='btn_projects'>Support type</button>
                </div>
            <div className='logout'>
                <button className='btn_logout' onClick={log_out}>Logout <i class="fa fa-sign-out" ></i> </button>
